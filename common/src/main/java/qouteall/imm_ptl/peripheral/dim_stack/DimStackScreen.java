...
public class DimStackScreen extends Screen {
    ...
    private void onAddEntry() {
        ...
        // 26.2: Minecraft.setScreen(Screen) moved to Minecraft.gui.setScreen (Gui.java; the
        // Minecraft.gui field is public final, Minecraft.java:290).
    ...
    private void onEditEntry() {
        ...
        Minecraft.getInstance().gui.setScreen(new DimStackEntryEditScreen(
            this, selected,
            () -> {
