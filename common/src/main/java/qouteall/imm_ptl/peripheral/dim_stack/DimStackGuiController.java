...
public class DimStackGuiController {
    ...
    private void showConflictingAlert() {
        // 26.2: Minecraft.setScreen(Screen) moved to Minecraft.gui.setScreen (Minecraft.gui public
        // final, Minecraft.java:290) — applied at all setScreen sites in this controller.
