...
public class WorldWrappingPortal extends GlobalTrackedPortal {
    public static final EntityType<WorldWrappingPortal> ENTITY_TYPE =
        createPortalEntityType(WorldWrappingPortal::new, Portal.portalEntityTypeKey("border_portal"));
    ...
    private static WorldWrappingPortal createWrappingPortal(
        ...
        WorldWrappingPortal portal = WorldWrappingPortal.ENTITY_TYPE.create(serverWorld, EntitySpawnReason.LOAD);
    ...
    public static void initWrappingPortal(
        ...
        portal.setAxisW(Vec3.atLowerCornerOf(axises.getFirst().getUnitVec3i()));
        portal.setAxisH(Vec3.atLowerCornerOf(axises.getSecond().getUnitVec3i()));
        portal.setWidth(Helper.getCoordinate(areaSize, axises.getFirst().getAxis()));
        portal.setHeight(Helper.getCoordinate(areaSize, axises.getSecond().getAxis()));
