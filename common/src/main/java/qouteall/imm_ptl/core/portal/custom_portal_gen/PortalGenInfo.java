...
public class PortalGenInfo {
    ...
    public <T extends Portal> T createTemplatePortal(EntityType<T> entityType) {
        ...
        // 26.2: EntityType.create(Level) → create(Level, EntitySpawnReason) (ducks-api-misc.md C11). Uses
        // EntitySpawnReason.LOAD to match the whole ported portal subsystem (PortalManipulation.java:91/134/
        // 161/256, NetherPortalGeneration.java:133) — the reason IP portal entities are created with.
