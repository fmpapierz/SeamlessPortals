...
public class BlockPortalShape {
    ...
    public void initPortalAxisShape(Portal portal, Vec3 center, Direction facing) {
        ...
        Direction wDirection = perpendicularDirections.getFirst();
        Direction hDirection = perpendicularDirections.getSecond();
    ...
    public static boolean isSquareShape(BlockPortalShape shape, int length) {
        ...
        return Helper.getCoordinate(areaSize, xs.getFirst()) == length &&
            Helper.getCoordinate(areaSize, xs.getSecond()) == length &&
    ...
    public static BlockPortalShape getSquareShapeTemplate(
        ...
        for (int i = 0; i < length; i++) {
            for (int j = 0; j < length; j++) {
                area.add(
                    BlockPos.ZERO.relative(perpendicularDirections.getFirst(), i)
                        .relative(perpendicularDirections.getSecond(), j)
                );
            }
        }
