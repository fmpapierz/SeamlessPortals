...
// S12-A Iris compile-shell (VERBATIM IP). Body is ENTIRELY commented out in IP ("only compilable with the
// next version of Iris" — it references ShadowRenderTargets/DepthTexture/DepthBufferFormat). Ported byte-for-
// byte as an empty class; the commented Storage/swapper logic is preserved for source-shape fidelity. Held/
// inert until S13; Iris never loads on 26.2 (no Iris build).
